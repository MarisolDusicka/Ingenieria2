  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="menuAdmin">
      ...
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        ...
        <!-- ANTEOJOS -->
       <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('listar_anteojos'); ?>">Gestionar Anteojos</a>
        </li>
         <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('agregar_anteojo'); ?>">Registrar Anteojos</a>
        </li>
